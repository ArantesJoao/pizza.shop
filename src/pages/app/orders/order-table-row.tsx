...
export const OrderTableRow = ({ order }: OrderTableRowProps) => {
  ...
  function updateOrderStatusOnCached(orderId: string, status: OrderStatus) {
    const cachedOrdersLists = queryClient.getQueriesData<GetOrdersResponse>({
      queryKey: ['orders'],
    })

    cachedOrdersLists.forEach(([cacheKey, cacheData]) => {
      if (!cacheData) {
        return
      }
